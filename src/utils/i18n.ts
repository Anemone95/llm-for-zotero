/**
 * Centralized i18n module for zotero-codex-claude.
 *
...
const PLUGIN_DISPLAY_NAME = config.addonName;
  ...
  if (getEffectiveLocale().startsWith("zh")) {
    return `
      <div class="llm-start-page">
        <div class="llm-start-page-title">${PLUGIN_DISPLAY_NAME}</div>
  ...
  if (getEffectiveLocale().startsWith("zh")) {
    return `
      <div class="llm-standalone-start-page">
        <div class="llm-start-page-title">${PLUGIN_DISPLAY_NAME} Agent</div>
