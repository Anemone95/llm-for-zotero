...
import {
  ...
  type ReferenceSelectorTagInfo,
  type ReferenceSelectorTagIndexItem,
  type ReferenceSelectorTagMatchMode,
  type ReferenceSelectorTagScope,
...
export function createPaperPickerController(deps: PaperPickerControllerDeps): {
  ...
  const createPaperPickerTagScopeButton = (
    ownerDoc: Document,
    scope: Exclude<ReferenceSelectorTagScope, "all">,
    label: string,
    baseGroups: readonly PaperSearchGroupCandidate[],
  ): HTMLElement => {
  ...
  const createPaperPickerTagChip = (
    ownerDoc: Document,
    info: ReferenceSelectorTagInfo,
    selected: boolean,
    available: boolean,
    baseGroups: readonly PaperSearchGroupCandidate[],
  ): HTMLElement => {
    const normalized = normalizeReferenceSelectorTagIdentityName(info.name);
    const wrap = createElement(
      ownerDoc,
      "div",
