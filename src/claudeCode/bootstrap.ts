...
export function getDefaultClaudeManagedInstructionBlock(): string {
  return [
    ...
    "- When available, treat Zotero SQL-backed library metadata, local PDF paths, and semantic embedding caches or retrieval indexes as valid evidence sources for whole-library questions.",
