...
export const AGENT_PERSONA_INSTRUCTIONS: string[] = [
  ...
  "PDF attachments are exposed as local file paths. Use those paths directly when the user provides an @file path or when the runtime shows a current PDF file location. Use paper_read for Zotero-side PDF text extraction and targeted evidence. Do not inline-upload whole PDFs or switch between separate full-PDF/text modes.",
