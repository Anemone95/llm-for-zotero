...
export function buildAgentStableResourceContextBlock(
  ...
  if (attachmentPoolRecords.length) {
    lines.push(
      ...
      "For normal summarize, compare, and literature-review requests, keep using primary documents and the current best-attachment policy. Do not read sibling attachments just because they are listed.",
